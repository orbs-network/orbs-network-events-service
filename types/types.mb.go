...
func (x *GetEventsInput) ClientRequest() *IndexerRequest {
	b, s := x._message.GetMessage(0)
	return IndexerRequestReader(b[:s])
}
...
type GetEventsInputBuilder struct {
	ClientRequest *IndexerRequestBuilder
...
type GetEventsOutput struct {
	// ClientResponse IndexerResponse
...
func (x *GetEventsOutput) ClientResponse() *IndexerResponse {
	b, s := x._message.GetMessage(0)
	return IndexerResponseReader(b[:s])
}
...
type GetEventsOutputBuilder struct {
	ClientResponse *IndexerResponseBuilder
